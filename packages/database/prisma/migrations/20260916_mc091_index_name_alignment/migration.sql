...
-- IF EXISTS: databases built purely from newer migrations already
-- carry the camelCase names; only legacy databases need the rename.
ALTER INDEX IF EXISTS "Job_status_created_at_idx" RENAME TO "Job_status_createdAt_idx";
ALTER INDEX IF EXISTS "Recipe_created_at_id_idx" RENAME TO "Recipe_createdAt_id_idx";
